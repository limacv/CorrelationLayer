                                    ...
                                    cudaStream_t stream) 
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.type(), "correlation_forward", ([&] {
   ...
   correlation_forward<scalar_t><<<totalBlocksCorr, threadsPerBlock, 0>>> 
                                    ...
                                    cudaStream_t stream)
{
    ...
    for (int n = 0; n < num; ++n) {
      ...
      AT_DISPATCH_FLOATING_TYPES_AND_HALF(input2.type(), "lltm_forward_cuda", ([&] {
          ...
          correlation_backward_input1<scalar_t><<<totalBlocksCorr, threadsPerBlock, 0>>> (
    ...
    for(int n = 0; n < batchSize; n++) {
      ...
      AT_DISPATCH_FLOATING_TYPES_AND_HALF(rInput1.type(), "lltm_forward_cuda", ([&] {
        ...
        correlation_backward_input2<scalar_t><<<totalBlocksCorr, threadsPerBlock, 0>>>(
